...
public class DisableAliCloudServerGroupAtomicOperationConverterTest extends CommonConverter {
  ...
  public void testConvertOperation() {
    ...
    assertTrue(atomicOperation instanceof DisableAliCloudServerGroupAtomicOperation);
  }

  @Test
  public void testConvertDescription() {
    DisableAliCloudServerGroupDescription disableAliCloudServerGroupDescription =
        converter.convertDescription(buildDescription());
    assertTrue(
        disableAliCloudServerGroupDescription instanceof DisableAliCloudServerGroupDescription);
  }
