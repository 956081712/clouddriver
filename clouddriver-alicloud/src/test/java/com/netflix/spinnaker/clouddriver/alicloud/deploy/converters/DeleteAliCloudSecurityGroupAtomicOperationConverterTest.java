...
public class DeleteAliCloudSecurityGroupAtomicOperationConverterTest extends CommonConverter {
  ...
  DeleteAliCloudSecurityGroupAtomicOperationConverter converter =
      new DeleteAliCloudSecurityGroupAtomicOperationConverter(clientFactory);
  ...
  public void testConvertOperation() {
    ...
    assertTrue(atomicOperation instanceof DeleteAliCloudSecurityGroupAtomicOperation);
  }

  @Test
  public void testConvertDescription() {
    DeleteAliCloudSecurityGroupDescription deleteAliCloudSecurityGroupDescription =
        converter.convertDescription(buildDescription());
    assertTrue(
        deleteAliCloudSecurityGroupDescription instanceof DeleteAliCloudSecurityGroupDescription);
  }
