...
public class EnableAliCloudServerGroupAtomicOperationConverterTest extends CommonConverter {

  EnableAliCloudServerGroupAtomicOperationConverter converter =
      new EnableAliCloudServerGroupAtomicOperationConverter(clientFactory);
  ...
  public void testConvertOperation() {
    ...
    assertTrue(atomicOperation instanceof EnableAliCloudServerGroupAtomicOperation);
  }

  @Test
  public void testConvertDescription() {
    EnableAliCloudServerGroupDescription enableAliCloudServerGroupDescription =
        converter.convertDescription(buildDescription());
    assertTrue(
        enableAliCloudServerGroupDescription instanceof EnableAliCloudServerGroupDescription);
  }
