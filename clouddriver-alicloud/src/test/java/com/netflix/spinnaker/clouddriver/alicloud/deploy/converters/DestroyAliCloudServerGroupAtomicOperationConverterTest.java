...
public class DestroyAliCloudServerGroupAtomicOperationConverterTest extends CommonConverter {
  ...
  public void testConvertOperation() {
    ...
    assertTrue(atomicOperation instanceof DestroyAliCloudServerGroupAtomicOperation);
  }

  @Test
  public void testConvertDescription() {
    DestroyAliCloudServerGroupDescription destroyAliCloudServerGroupDescription =
        converter.convertDescription(buildDescription());
    assertTrue(
        destroyAliCloudServerGroupDescription instanceof DestroyAliCloudServerGroupDescription);
  }
