...
@AliCloudOperation(AtomicOperations.UPDATE_LAUNCH_CONFIG)
@Component("updateAliCloudLaunchConfigDescription")
public class UpdateAliCloudLaunchConfigAtomicOperationConverter
  ...
  public AtomicOperation convertOperation(Map input) {
    return new UpdateAliCloudLaunchConfigAtomicOperation(
        convertDescription(input), getObjectMapper(), clientFactory);
  }

  @Override
  public UpdateAliCloudLaunchConfigDescription convertDescription(Map input) {
    UpdateAliCloudLaunchConfigDescription description =
        getObjectMapper().convertValue(input, UpdateAliCloudLaunchConfigDescription.class);
